...
namespace MedicHp.Application.Features.Appointments.DTOs;
...
public class AppointmentDto
{
    ...
    public List<MedicHp.Application.Features.Doctors.DTOs.DoctorPaymentMethodDto>? PaymentMethods { get; set; }
}
