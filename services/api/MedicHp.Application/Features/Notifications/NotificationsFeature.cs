...
namespace MedicHp.Application.Features.Notifications.DTOs
{
...
namespace MedicHp.Application.Features.Notifications.Queries.GetNotifications
{
    using MedicHp.Application.Features.Notifications.DTOs;
...
namespace MedicHp.Application.Features.Notifications.Commands.MarkNotificationAsRead
{
    ...
    public class MarkNotificationAsReadCommandHandler : IRequestHandler<MarkNotificationAsReadCommand, bool>
    {
        ...
        public async Task<bool> Handle(MarkNotificationAsReadCommand request, CancellationToken cancellationToken)
        {
            ...
            if (notification == null || notification.UserId != request.UserId)
                throw new MedicHp.Shared.Exceptions.NotFoundException(nameof(Notification), request.Id);
