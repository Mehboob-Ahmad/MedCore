...
using MedCore.Application.Features.Notifications.Commands.MarkNotificationAsRead;
using MedCore.Application.Features.Notifications.Queries.GetNotifications;
using MediatR;
