...
using MedicHp.Application.Features.Records.Queries.GetConsultationSummary;
using MedicHp.Application.Features.Records.Queries.GetPrescription;
using MedicHp.Application.Features.Records.Queries.GetTimeline;
using MediatR;
