...
using MedicHp.Application.Features.Templates.Commands.CreateConsultationTemplate;
using MedicHp.Application.Features.Templates.Commands.CreatePrescriptionTemplate;
using MediatR;
