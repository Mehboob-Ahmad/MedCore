...
using MedicHp.Application.Features.Appointments.Commands.BookAppointment;
using MedicHp.Application.Features.Appointments.Commands.CancelAppointment;
using MedicHp.Application.Features.Appointments.Commands.RescheduleAppointment;
using MedicHp.Application.Features.Appointments.Commands.UpdateAppointmentStatus;
using MedicHp.Application.Features.Appointments.Queries.GetAppointmentDetails;
using MedicHp.Application.Features.Appointments.Queries.GetDoctorAppointments;
using MedicHp.Application.Features.Appointments.Queries.GetPatientAppointments;
...
public class AppointmentsController : ControllerBase
{
    ...
    /// <summary>
    /// Confirm payment for an appointment (Doctor)
    /// </summary>
    ...
    public async Task<IActionResult> ConfirmPayment(Guid id)
    {
        ...
        var command = new MedicHp.Application.Features.Appointments.Commands.ConfirmPayment.ConfirmPaymentCommand
        {
            AppointmentId = id,
