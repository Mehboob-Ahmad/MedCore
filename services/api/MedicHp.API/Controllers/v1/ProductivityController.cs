...
using MedicHp.Application.Features.Favorites.Commands.AddFavoriteMedicine;
using MedicHp.Application.Features.Favorites.Commands.RemoveFavoriteMedicine;
using MedicHp.Application.Features.Favorites.Queries.GetFavoriteMedicines;
using MedicHp.Application.Features.Productivity.Commands.CopyPreviousPrescription;
using MedicHp.Application.Features.Productivity.Queries.GetClinicalReminders;
using MedicHp.Application.Features.Productivity.Queries.GetDoctorAnalytics;
using MedicHp.Application.Features.Productivity.Queries.GetDoctorDrafts;
using MedicHp.Application.Features.Productivity.Queries.GetFollowUpManagerData;
using MedicHp.Application.Features.Productivity.Queries.GetRecentMedicines;
using MediatR;
